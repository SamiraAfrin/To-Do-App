...
func (_m *Repository) GetAllUser(ctx context.Context) ([]*models.User, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) Store(ctx context.Context, a *models.User) error {
	ret := _m.Called(ctx, a)
...
func (_m *Repository) Update(ctx context.Context, a *models.User) error {
	ret := _m.Called(ctx, a)
